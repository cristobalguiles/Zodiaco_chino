...
let zodiaco2 = Zodiaco(signo: "Cabra", fechaInicioSignoZodiaco: "15/02/1991", fechaFinSignoZodiaco: "03/02/1992", descripcion: "La Cabra es sumamente tranquila y dócil, aunque por dentro sea un volcán de emociones. Necesita el apoyo del entorno para poder seguir sus proyectos personales. Temen dañar a los demás con sus acciones por su alto sentido de la honestidad y sinceridad. Su poca capacidad para expresar sus sentimientos, hace que sufran en silencio. Son cariñosas con las personas que quiere y respeta. En ocasiones se dejan llevar por el pesimismo.", compatibilidadEntreSignos: "La cabra es compatible con el cerdo y el conejo")

let zodiaco3 = Zodiaco(signo: "Mono", fechaInicioSignoZodiaco: "04/02/1992", fechaFinSignoZodiaco: "22/01/1993", descripcion: "Este signo es el noveno del zodíaco. Es práctico y capaz de ejecutar cualquier tipo de proyecto. Es un animal que puede tener dos caras, una divertida y otra sin ningún tipo de moral. No se preocupa en exceso por los demás, ya que las preocupaciones del entorno no le quitan el sueño. Su objetivo es divertirse y sentirse satisfecho por lo que desarrollan un alto sentido de la independencia.", compatibilidadEntreSignos: "El mono es compatible con la rata y el dragón")

let zodiaco4 = Zodiaco(signo: "Gallo", fechaInicioSignoZodiaco: "23/01/1993", fechaFinSignoZodiaco: "09/02/1994", descripcion: "Es el que manda en el corral y así lo hace sentir al resto del grupo. El Gallo es trabajador y honesto pero también vanidoso. Ama la controversia y la polémica. No admite sus errores con facilidad y ama la perfección y los detalles. Es un buen amigo aunque quien le acompañe debe aprender a lidiar con su ego exacerbado y su deseo constante de halagos y adulaciones.", compatibilidadEntreSignos: "El gallo es compatible con la serpiente y el buey")

let zodiaco5 = Zodiaco(signo: "Perro", fechaInicioSignoZodiaco: "10/02/1994", fechaFinSignoZodiaco: "30/01/1995", descripcion: "Dispuesto a ayudar a todos, gracias a su entrega y hospitalidad. Fiel por naturaleza y convicción, el dinero no es su principal motor o norte. Sin embargo, son desconfiados con sus afectos hasta que sienten que pueden entregarse completamente. Es tomado como líder aunque la idea no le agrade del todo. Precisamente su espíritu fuerte y difícil de doblegar, hace que los otros sientan que pueden apoyarse en él.", compatibilidadEntreSignos: "El perro es compatible con el tigre y el caballo")

let zodiaco6 = Zodiaco(signo: "Cerdo", fechaInicioSignoZodiaco: "31/01/1995", fechaFinSignoZodiaco: "18/02/1996", descripcion: "El Cerdo o Jabalí es altamente apreciado por su generosidad. Actúa siempre de buena fe, guiados por principios nobles. Tienen mucho talento para las actividades académicas así como los negocios y emprendimientos. Tardan en tomar decisiones pero cuando lo hacen son determinantes. Poseen un gran sentido del humor que los hace ser buscados en los círculos sociales.", compatibilidadEntreSignos: "El cerdo es compatible con el conejo y la oveja")

let zodiaco7 = Zodiaco(signo: "Rata", fechaInicioSignoZodiaco: "19/02/1996", fechaFinSignoZodiaco: "07/02/1997", descripcion: "Es un signo tan inteligente y astuto como escurridizo. Para los chinos es vista la rata como un animal que atrae la prosperidad con dotes de protección. Son grandes conversadores pero no por ello confían sus problemas e inquietudes con facilidad. Pueden ocupar con facilidad, posiciones de autoridad por su don de mando. Uno de sus mayores defectos es la codicia, lo que le impide retirarse a tiempo antes de perder en los negocios.", compatibilidadEntreSignos: "La rata es compatible con el dragon y el mono")

let zodiaco8 = Zodiaco(signo: "Buey", fechaInicioSignoZodiaco: "08/02/1997", fechaFinSignoZodiaco: "27/01/1998", descripcion: "Como la analogía con el animal, los nacidos bajo este signo son sumamente trabajadores y consecuentes en su faena diaria. Asumen todas las responsabilidades sin queja alguna y de la mejor forma. Son humanitarios y preocupados por las causas sociales. No soportan los riesgos por lo que difícilmente se les verá en situaciones límite. Muy cariñosos y afectuosos con las personas que aprecia. No se compromete si no cree que pueda cumplir su palabra", compatibilidadEntreSignos: "El buey es compatible con la serpiente y el gallo")

let zodiaco9 = Zodiaco(signo: "Tigre", fechaInicioSignoZodiaco: "28/01/1998", fechaFinSignoZodiaco: "15/02/1999", descripcion: "Rebeldes y valientes, ven la vida desde otra perspectiva, siempre en búsqueda de la aventura y las emociones intensas. No tienen medias tintas, o son amados e idolatrados por su entorno u odiados y rechazados. Siempre son el centro de atención en cualquier tipo de reunión social. En el amor son eternos enamorados y muy románticos aunque cuando son heridos y traicionados pueden tornarse despiadados. Están sumergidos constantemente en un huracán de emociones que impiden que puedan ser previsibles sus acciones.", compatibilidadEntreSignos: "El tigre es compatible con el caballo y el perro")

let zodiaco10 = Zodiaco(signo: "Liebre", fechaInicioSignoZodiaco: "16/02/1999", fechaFinSignoZodiaco: "04/02/2000", descripcion: "Al Conejo le encanta la comodidad y la seguridad, por lo que nunca podrá asociársele con ambientes competitivos y arriesgados. Aman el lujo y no procurar liderar o dirigir grupos o situaciones. Son justos y equilibrados, aunque un tanto distantes y hasta frívolos. Disfruta de los encuentros sociales como parte de un todo y no como centro de todas las miradas. No son comunicativos por naturaleza pero son buenos consejeros sin involucrarse demasiado o abrir en exceso su corazón.", compatibilidadEntreSignos: "El conejo es compatible con el cerdo y la cabra")

let zodiaco11 = Zodiaco(signo: "Dragón", fechaInicioSignoZodiaco: "05/02/2000", fechaFinSignoZodiaco: "23/01/2001", descripcion: "Es un signo de buena suerte, bajo su influencia se registra el nacimiento de mayor cantidad de bebés que en cualquier otro signo. Tienen mucho magnetismo y atractivo personal. Nobles y francos aunque también contrasta su personalidad arrogante e intolerante. En el plano laboral puede ser déspota al imponer sus puntos de vista.", compatibilidadEntreSignos: "El dragón es compatible con la rata y el mono")
